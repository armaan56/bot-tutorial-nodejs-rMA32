...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://imgflip.com/i/1j291p");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://daddyleagues.com/cgl/rules");
    this.res.end();
  } 
  else if(request.text && botRegexGTA.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://daddyleagues.com/cgl/stats/rookie");
    this.res.end();
  } 
  else if(request.text && botRegexSC.test(request.text)) {
    this.res.writeHead(200);
    
    postMessage("http://daddyleagues.com/cgl/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/cgl/players?name="+rep+"&position=all&team=all");
    ...
    this.res.writeHead(200);
    postMessage("http://www.reddit.com/r/cgl");
    this.res.end();
  } 
